	...
	return (
		<section id="how" className="grid w-screen h-[max(150%,100vh)] sm:h-[110vh] md:h-[100vh] lg:h-[80vh] xl:h-[60vh] grid-cols-1 grid-rows-2 lg:grid-rows-1 lg:grid-cols-2 place-items-center p-8 bg-white">
			...
			<div className="flex flex-col justify-start items-start relative md:flex-row gap-4 w-[100%] h-80 md:mt-0">
				<div className="scale-[40%] sm:scale-[50%] md:scale-[50%] xl:scale-[65%] 2xl:scale-100 left-[10%] md:left-[35%] sm:left-[30%] -top-[max(20%,50px)] sm:top-[-40%] md:-top-[max(5%,20px)] lg:top-[0%] xl:top-[0%] lg:left-[0%] xl:top-[-20%]   transition-all duration-500 ease-in-out absolute">
